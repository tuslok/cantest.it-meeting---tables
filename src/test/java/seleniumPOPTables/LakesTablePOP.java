...
public class LakesTablePOP extends BasePage {
    ...
    private void readLakes() {
        List<WebElement> lakesWebElements = driver.findElements(By.cssSelector("#main table tbody tr"));
        for (WebElement row : lakesWebElements) {
            ...
            lakes.put(name, new LakePO(name, country, area));
        }
    }
